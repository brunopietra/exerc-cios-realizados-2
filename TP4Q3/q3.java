...
class No {
     ...
     * @throws Exception
     */
    public No(String arquivo, No esq, No dir, int nivel) throws Exception {
...
public class q3{
    ...
    public static void gerarArq(long time, Comp comp) throws Exception{
        try{
            PrintWriter writer = new PrintWriter("matricula_avl.txt", "UTF-8");
            writer.printf("matricula: 726911\ttempo de execucao: %d milissegundos\tnumero de comparacoes: %d", time/1000000, comp.getComp());
