    ...
    public static void main(String[] args)throws Exception{
        ...
        for(int i = 0; i < lista.n; i++){
            for(int j = i + 1; j < lista.n; j++){
                if((lista.array[i].getPais()).compareTo(lista.array[j].getPais()) > 0){
                    Serie sup = lista.array[i];
                ...
                else if((lista.array[i].getPais()).compareTo(lista.array[j].getPais()) == 0){
                    if((lista.array[i].getNome()).compareTo(lista.array[j].getNome()) > 0){
                        Serie sup = lista.array[i];
                        lista.array[i] = lista.array[j];
                        lista.array[j] = sup;
