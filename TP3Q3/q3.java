    ...
    public static void main(String[] args)throws Exception{
        ...
        for (int i = 1; i < lista.n; i++){
            ...
            for(int j = i - 1; j >= 0; j--){
                ...
                //System.out.printf("Comparando %s com %s\n", lista.array[x].getNome(), lista.array[j].getNome());

                if((lista.array[x].getIdioma()).compareTo(lista.array[j].getIdioma()) < 0){
                    Serie sup = lista.array[x];
                    lista.array[x] = lista.array[j];
                    lista.array[j] = sup;
                    x = j;
                ...
                else if((lista.array[x].getIdioma()).compareTo(lista.array[j].getIdioma()) == 0){
                    if((lista.array[x].getNome()).compareTo(lista.array[j].getNome()) < 0){
                        Serie sup = lista.array[x];
                        lista.array[x] = lista.array[j];
                        lista.array[j] = sup;
                        x = j;
