...
class ArvoreBinaria {
	 ...
	 */
	public void inserir(String nomeArquivo, Comp comp) throws Exception {
		...
		raiz = inserir(nomeArquivo, aux.getNome(), raiz, comp);
	 ...
	 * @throws Exception Se o elemento existir.
	 */
	private No inserir(String x, String xNome, No i, Comp comp) throws Exception {
		...
		if (i == null) {
         ...
         i.esq = inserir(x, xNome, i.esq, comp);
         comp.addComp(2);

      } else if (xNome.compareTo(i.elemento.getNome()) > 0) {
         i.dir = inserir(x, xNome, i.dir, comp);
         comp.addComp(3);
...
public class q5{
    ...
    public static void gerarArq(long time, Comp comparacoes) throws Exception{
        try{
            PrintWriter writer = new PrintWriter("matricula_treesort.txt", "UTF-8");
    ...
    public static void main (String []args) throws Exception{
        ...
        while(!nomeArquivo.equals("FIM")){
            try{
                arvore.inserir(nomeArquivo, comp);
